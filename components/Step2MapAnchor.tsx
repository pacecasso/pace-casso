...
const applyArtistLoopResult = useCallback((result: ArtistLoopResultPayload) => {
    ...
    const pick: Top5Pick = {
      ...
      snappedRoute: {
        ...
        preserveBlockWaypoints: true,
        verified: result.recognizedCount >= 2,
      },
      previewDataUrl: renderRouteToDataUrl(result.chain, 640, { padding: 40 }) ?? "",
...
const applyPaintResult = useCallback((result: PaintRoutePayload, stillSearching: boolean) => {
    ...
    const pick: Top5Pick = {
      ...
      previewDataUrl: renderRouteToDataUrl(chain, 640, { padding: 40 }) ?? "",
