...
const designs = [
  { id: "sneaker-c", label: "Sneaker C", subject: "sneaker", reference: "sneaker.jpg", points: sneakerCandidateC(), intent: "high-top shoe: curved sole, toe, ankle opening, heel, zigzag laces, tread" },
  { id: "witch-c", label: "Witch C", subject: "witch", reference: "witch.jpg", points: witchCandidateC(), intent: "witch hat, brim, face/hair, nose, broom bristles" },
  { id: "witch-d", label: "Witch D", subject: "witch", reference: "witch.jpg", points: witchCandidateD(), intent: "witch riding a broom: diagonal broom, body, pointed hat, hair" },
];
