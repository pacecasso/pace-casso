...
async function main() {
  ...
  const fits = [];
  for (const top of [212, 218, 224]) for (const bottom of [444, 452, 460]) {
    for (const south of [40.700, 40.703, 40.706]) for (const north of [40.729, 40.733, 40.737]) {
      for (const west of [-74.024, -74.020, -74.016]) for (const east of [-73.986, -73.981, -73.976, -73.971]) {
  ...
  for (const fit of fits.slice(0, 6)) {
    const rawTarget = points.map((p) => pixelToLl(p, fit));
    for (const simplifyM of [85, 125]) {
      for (const anchorM of [155, 215]) {
