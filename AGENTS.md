...
| 2 | `Step2MapAnchor` | Codex vision ranks 5 candidate placements on city streets |
...
`~/.Codex/projects/<hash>/memory/user.md`). Pending queue (ranked by
impact per hour):
